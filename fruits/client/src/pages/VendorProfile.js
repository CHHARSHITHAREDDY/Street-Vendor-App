...
const VendorProfile = () => {
  ...
  if (!vendor) {
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Vendor Not Found</h1>
          <p className="text-gray-600 mb-4">This vendor does not exist.</p>
  ...
  const isCurrentlyOpen = () => {
    ...
    const [sh, sm] = vendor.operatingHours.start.split(':').map(Number);
    const [eh, em] = vendor.operatingHours.end.split(':').map(Number);
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between">
            ...
            <div className="mt-4 lg:mt-0">
              <div className="flex flex-col gap-2">
                <button onClick={() => handleContact('phone', vendor.phone)} className="btn-primary flex items-center gap-2">
                  <Phone className="w-4 h-4" /> Call
                </button>

                <button onClick={() => handleContact('email', vendor.email)} className="btn-outline flex items-center gap-2">
                  <Mail className="w-4 h-4" /> Email
                </button>

                <button onClick={handleDirections} className="btn-secondary flex items-center gap-2">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card">
              ...
              {products.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {products.map((product) => (
                    <div key={product._id} className="border p-4 rounded-lg hover:shadow">
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <div className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-gray-400" />
                  {vendor.rating.toFixed(1)} / 5 ({vendor.totalRatings})
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                <button className="flex items-center gap-2 hover:bg-gray-50 p-2 rounded" onClick={() => handleContact('phone', vendor.phone)}>
                  <Phone className="w-4 h-4 text-gray-400" /> {vendor.phone}
                </button>

                <button className="flex items-center gap-2 hover:bg-gray-50 p-2 rounded" onClick={() => handleContact('email', vendor.email)}>
            ...
            <div className="card">
              ...
              <div className="space-y-2">
                <button className="btn-primary w-full flex items-center justify-center gap-2" onClick={handleDirections}>
